...
from classroom.views.students import AllQuizzes, TakeQuiz, QuizQuestions, PostAnswer, UpdateRandomquiz, CalculateScore, \
    Taken, Subjects, DeleteQuizTaken, DeleteQuizAnswer, DeleterQuizRandom, QuestionAnswer
...
urlpatterns = [
    ...
    path('questionanswers/<int:question_id>', QuestionAnswer.as_view()),
    ...
    path('deletequizanswer/<int:student_id>/<int:quiz>', DeleteQuizAnswer.as_view()),
    path('deleterquizrandom/<int:student_id>/<int:quiz>', DeleterQuizRandom.as_view()),
    path('deletequiztaken/<int:student_id>/<int:quiz>', DeleteQuizTaken.as_view()),
