...
class JobApplication(models.Model):
    ...
    interviewstatus = models.CharField(max_length=500, null=True, blank=True)
    ...
    offerstatus = models.CharField(max_length=500, null=True, blank=True)
    offerletter = models.CharField(max_length=500, null=True, blank=True)
    ...
    framework = models.CharField(max_length=500, null=True, blank=True)
